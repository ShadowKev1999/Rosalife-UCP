...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0 text-secondary">Immobilien - Tankstellen</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="/">Home</a></li>
        <li class="breadcrumb-item">Administration</li>
        <li class="breadcrumb-item active">Immobilien - Tankstellen</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
@endsection
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><span>{{$item->EPos_X}}, {{$item->EPos_Y}}, {{$item->EPos_Z}}</span></td>
                </tr>
                @endforeach
            </tbody>
        </table>
